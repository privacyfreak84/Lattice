...
/**
 * AES-256-GCM helper mirroring [com.dresos.nexus.data.crypto.DatabaseKey]'s parameters (12-byte random
 ...
 * Config kept explicit and in lockstep with [com.dresos.nexus.mesh.protocol.WireCodec] so the frozen wire
 * contract is spelled out, not implied by library defaults: `encodeDefaults = false` (the null-field
 * omission [com.dresos.nexus.mesh.crypto.MessageContent] relies on) and definite-length CBOR (iOS-codec
