...
import com.dresos.nexus.ui.hasAllMeshPermissions
 ...
 * ([com.dresos.nexus.ui.KnitApp]) and `START_STICKY` doesn't survive a reboot.
 *
 ...
 * [com.dresos.nexus.notifications.NotificationActionReceiver].
 */
class BootReceiver :
    BroadcastReceiver(),
    KoinComponent {
