...
object Protocol {
     ...
     * ([com.dresos.nexus.data.forward.ForwardRepository.store]) so it can't become un-sweepable and win
     ...
     * ([com.dresos.nexus.mesh.InboundPipeline.deliverChat]) so a future-dated frame can't pin itself to the
