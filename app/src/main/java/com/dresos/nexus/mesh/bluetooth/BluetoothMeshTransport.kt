...
import com.dresos.nexus.mesh.ConnectFailReason
 ...
 * [com.dresos.nexus.mesh.wifiaware.WifiAwareTransport] behind [com.dresos.nexus.mesh.CompositeMeshTransport].
...
class BluetoothMeshTransport(
    ...
    private fun registerLink(
        ...
        link: com.dresos.nexus.mesh.link.LinkSocket,
    ) {
        val framed =
            FramedLink(
                nodeId = nodeId,
