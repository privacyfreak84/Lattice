 ...
 * [com.dresos.nexus.demo.DemoDirector] (debug-only) emits commands; a `BuildConfig.DEMO_DIRECTOR`-gated
 ...
 *
 * Lives in `src/main` (like [com.dresos.nexus.ui.share.ShareInbox]) so `ChatScreen` can reference it in
