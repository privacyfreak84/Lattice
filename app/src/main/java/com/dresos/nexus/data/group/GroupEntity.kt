package com.dresos.nexus.data.group
 ...
 * [com.dresos.nexus.data.message.Conversations.groupIdFor]) and carried on every group message (it
 * doubles as the message [com.dresos.nexus.data.message.MessageEntity.conversationId]). [name] is the
 * explicit group name, or blank (`""`) when unnamed — an unnamed group's title is generated locally per
 * device from its members (see [com.dresos.nexus.data.message.groupTitle]). [nameUpdatedAt] is the
 ...
 * [com.dresos.nexus.data.message.MentionStore].
 */
