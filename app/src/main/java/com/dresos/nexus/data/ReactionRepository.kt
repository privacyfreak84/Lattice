 ...
 * receive paths in [com.dresos.nexus.mesh.MeshManager] share one definition of "newer wins".
 */
class ReactionRepository(
     ...
     * (out-of-order mesh delivery) isn't reaped — see [com.dresos.nexus.data.reaction.ReactionEntity].
     */
