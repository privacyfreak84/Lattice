 ...
 * classifier, caching verdicts) lives in [com.dresos.nexus.moderation.ImageScreeningService]; this class
...
class BlobRepository(
     ...
     * via a later [com.dresos.nexus.mesh.BlobExchange] re-pull. The own-avatar guard reads DataStore,
     ...
     * The eager carrier-pull ([com.dresos.nexus.mesh.InboundPipeline.onCarriedFrame]) uses this as a pull-time
