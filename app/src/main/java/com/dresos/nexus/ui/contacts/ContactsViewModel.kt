...
class ContactsViewModel(
     ...
     * renders its own default from the members; see [com.dresos.nexus.data.message.groupTitle]) until
     * someone renames it. Emits on [created] only after the row exists (no startup race in
     * [com.dresos.nexus.ui.chat.ChatViewModel]); members learn of a new group on its first message.
     */
