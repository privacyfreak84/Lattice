...
class MainActivity : FragmentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // `adb shell am start -n com.dresos.lattice/.MainActivity --es demo_route chat/nearby`. Gated to
    ...
    companion object {
        /** Deep-link route extra set by [com.dresos.lattice.notifications.MessageNotifier] on a notification tap. */
        const val EXTRA_ROUTE = "com.dresos.lattice.NOTIF_ROUTE"
