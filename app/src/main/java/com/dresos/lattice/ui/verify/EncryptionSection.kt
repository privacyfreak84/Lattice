...
import com.dresos.lattice.ui.image.QrCode
 ...
 *  - a peer's read-only profile ([com.dresos.lattice.ui.profile.ProfileDetailsScreenContent]) passes a
 *    non-null [peer] and shows the full verification section; and
 *  - the standalone Verify-contact screen ([com.dresos.lattice.ui.verify.VerifyContactScreenContent])
