 ...
 * side of each action mirrors [com.dresos.lattice.ui.chat.ChatViewModel]'s send path
...
class GroupDetailsViewModel(
     ...
     * clocks). Kept in sync with [com.dresos.lattice.ui.chat.ChatViewModel]'s copy on the send path.
     */
