...
import com.dresos.lattice.mesh.DropReason
import com.dresos.lattice.mesh.FileKind
 ...
 * both [com.dresos.lattice.mesh.wifiaware.WifiAwareTransport] and the Bluetooth transport supply an impl that
 ...
 * JVM-unit-testable over a piped [LinkSocket] ([com.dresos.lattice.FramedLinkTest]). Callers pass
