...
object Protocol {
     ...
     * ([com.dresos.lattice.data.forward.ForwardRepository.store]) so it can't become un-sweepable and win
     ...
     * ([com.dresos.lattice.mesh.InboundPipeline.deliverChat]) so a future-dated frame can't pin itself to the
