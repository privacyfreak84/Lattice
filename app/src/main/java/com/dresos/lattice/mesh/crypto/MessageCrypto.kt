 ...
 * key persistence lives in [com.dresos.lattice.data.crypto.IdentityKeyStore].
 *
 ...
 * envelope is *not* signed here — it travels inside an encrypted [com.dresos.lattice.mesh.protocol.ChatContent]
 * payload, and the single frame signature over the whole [com.dresos.lattice.mesh.protocol.RelayEnvelope]
...
class MessageCrypto(
     ...
     * canonical [com.dresos.lattice.mesh.protocol.WireEnvelope.signed] blob (the one signature that now
