 ...
 * [com.dresos.lattice.mesh.MeshTransport.expectBulkTransfer] on the Wi-Fi Aware plane. A noted peer counts as
 ...
 * JVM-unit-tested ([com.dresos.lattice.BulkWantTrackerTest]); `@Synchronized` for the transport's
