 ...
 * broadcast) — see `com.dresos.lattice.mesh.ForwardSync`.
 *
 ...
 * [com.dresos.lattice.mesh.protocol.ChatContent] (null for a non-chat frame or a chat with no image). It lets a
