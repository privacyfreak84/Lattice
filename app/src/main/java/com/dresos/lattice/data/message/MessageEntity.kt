 ...
 * bytes live in the encrypted `blobs` table (see [com.dresos.lattice.data.blob.BlobEntity]), keyed by
 ...
 * [com.dresos.lattice.mesh.protocol.ReplyRef] so the quote renders even when the original was never
