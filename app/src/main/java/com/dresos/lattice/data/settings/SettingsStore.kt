 ...
 * no longer persisted here — it is derived from the E2E keypair; see [com.dresos.lattice.identity.Identity].)
 */
class SettingsStore(
    ...
    /**
     * Device tags (see [com.dresos.lattice.identity.DeviceTag]) the user has blocked. Because a nodeId is
     ...
     * the peer's node id, or a group keyed by its "g-…" id (see [com.dresos.lattice.data.message.Conversations]).
     ...
     * review-prompt engagement window (see [com.dresos.lattice.review.ReviewPromptPolicy]). Deliberately a
