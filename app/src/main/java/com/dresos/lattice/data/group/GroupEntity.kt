 ...
 * [com.dresos.lattice.data.message.Conversations.groupIdFor]) and carried on every group message (it
 * doubles as the message [com.dresos.lattice.data.message.MessageEntity.conversationId]). [name] is the
 * explicit group name, or blank (`""`) when unnamed — an unnamed group's title is generated locally per
 * device from its members (see [com.dresos.lattice.data.message.groupTitle]). [nameUpdatedAt] is the
 ...
 * [com.dresos.lattice.data.message.MentionStore].
 */
