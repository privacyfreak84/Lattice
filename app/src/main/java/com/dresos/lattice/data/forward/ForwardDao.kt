package com.dresos.lattice.data.forward
 ...
 * [com.dresos.lattice.mesh.StoreDigest] content digest, which needs the expiry alongside the id to drive its
...
interface ForwardDao {
     ...
     * side of the "still-missing blobs" set (mirrors [com.dresos.lattice.data.message.MessageDao.hashesNeedingFetch]).
