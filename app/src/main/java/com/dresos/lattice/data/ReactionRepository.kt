 ...
 * receive paths in [com.dresos.lattice.mesh.MeshManager] share one definition of "newer wins".
 */
class ReactionRepository(
     ...
     * (out-of-order mesh delivery) isn't reaped — see [com.dresos.lattice.data.reaction.ReactionEntity].
     */
