package com.dresos.lattice.data.peer
 ...
 * [com.dresos.lattice.data.blob.BlobEntity]) and are only set once the avatar payload has arrived, so a
 * non-null hash always implies the blob is present.
 *
 * [pubKey] is the peer's pinned end-to-end public-key bundle (base64; see
 * [com.dresos.lattice.mesh.crypto.PublicKeyBundle]), learned from their profile frame on a
 ...
 *
 * [deviceTag] is the peer's key-independent device tag (see [com.dresos.lattice.identity.DeviceTag]),
 ...
 * [com.dresos.lattice.mesh.protocol.Protocol]), learned (authenticated) from their profile frame; null
