 ...
 * bytes live in the encrypted `blobs` table (see [org.lattice.data.blob.BlobEntity]), keyed by
 ...
 * [org.lattice.mesh.protocol.ReplyRef] so the quote renders even when the original was never
