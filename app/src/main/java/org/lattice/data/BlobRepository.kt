 ...
 * classifier, caching verdicts) lives in [org.lattice.moderation.ImageScreeningService]; this class
...
class BlobRepository(
     ...
     * via a later [org.lattice.mesh.BlobExchange] re-pull. The own-avatar guard reads DataStore,
     ...
     * The eager carrier-pull ([org.lattice.mesh.InboundPipeline.onCarriedFrame]) uses this as a pull-time
