...
import org.lattice.ui.KnitApp
import org.lattice.ui.RouteInbox
import org.lattice.ui.applock.AppLockGate
import org.lattice.ui.share.ShareInbox
import org.lattice.ui.share.SharedContent
...
class MainActivity : FragmentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // `adb shell am start -n org.lattice/.MainActivity --es demo_route chat/nearby`. Gated to
    ...
    companion object {
        /** Deep-link route extra set by [org.lattice.notifications.MessageNotifier] on a notification tap. */
        const val EXTRA_ROUTE = "org.lattice.NOTIF_ROUTE"
