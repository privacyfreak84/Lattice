...
import org.lattice.mesh.ConnectFailReason
...
import org.lattice.mesh.link.LinkHandshake
import org.lattice.mesh.power.PowerPolicy
 ...
 * [org.lattice.mesh.wifiaware.WifiAwareTransport] behind [org.lattice.mesh.CompositeMeshTransport].
...
class BluetoothMeshTransport(
    ...
    private fun registerLink(
        ...
        link: org.lattice.mesh.link.LinkSocket,
    ) {
        val framed =
            FramedLink(
                nodeId = nodeId,
