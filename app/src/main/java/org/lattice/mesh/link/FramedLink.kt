...
import org.lattice.mesh.DropReason
 ...
 * both [org.lattice.mesh.wifiaware.WifiAwareTransport] and the Bluetooth transport supply an impl that
 ...
 * JVM-unit-testable over a piped [LinkSocket] ([org.lattice.FramedLinkTest]). Callers pass
