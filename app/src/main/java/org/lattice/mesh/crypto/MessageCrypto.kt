...
import org.lattice.mesh.protocol.WrappedKey
 ...
 * key persistence lives in [org.lattice.data.crypto.IdentityKeyStore].
 *
 ...
 * envelope is *not* signed here — it travels inside an encrypted [org.lattice.mesh.protocol.ChatContent]
 * payload, and the single frame signature over the whole [org.lattice.mesh.protocol.RelayEnvelope]
...
class MessageCrypto(
     ...
     * canonical [org.lattice.mesh.protocol.WireEnvelope.signed] blob (the one signature that now
