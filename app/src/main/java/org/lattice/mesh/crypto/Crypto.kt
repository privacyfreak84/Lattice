...
/**
 * AES-256-GCM helper mirroring [org.lattice.data.crypto.DatabaseKey]'s parameters (12-byte random
 ...
 * Config kept explicit and in lockstep with [org.lattice.mesh.protocol.WireCodec] so the frozen wire
 * contract is spelled out, not implied by library defaults: `encodeDefaults = false` (the null-field
 * omission [org.lattice.mesh.crypto.MessageContent] relies on) and definite-length CBOR (iOS-codec
