...
class ContactsViewModel(
     ...
     * renders its own default from the members; see [org.lattice.data.message.groupTitle]) until
     * someone renames it. Emits on [created] only after the row exists (no startup race in
     * [org.lattice.ui.chat.ChatViewModel]); members learn of a new group on its first message.
     */
