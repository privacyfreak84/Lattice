...
import org.lattice.ui.image.QrCode
 ...
 *  - a peer's read-only profile ([org.lattice.ui.profile.ProfileDetailsScreenContent]) passes a
 *    non-null [peer] and shows the full verification section; and
 *  - the standalone Verify-contact screen ([org.lattice.ui.verify.VerifyContactScreenContent])
