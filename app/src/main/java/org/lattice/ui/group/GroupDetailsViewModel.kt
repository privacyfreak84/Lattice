...
import org.lattice.ui.util.computeAvatarCrop
 ...
 * side of each action mirrors [org.lattice.ui.chat.ChatViewModel]'s send path
...
class GroupDetailsViewModel(
     ...
     * clocks). Kept in sync with [org.lattice.ui.chat.ChatViewModel]'s copy on the send path.
     */
