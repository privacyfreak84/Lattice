...
/**
 * Base for the **UIAutomator** black-box suite (`com.dresos.lattice.uiauto`). Where the Compose suite
 * ([com.dresos.lattice.ui.SeededUiTest]) drives the app *in-process* via the semantics tree, this drives the
...
abstract class SeededUiAutomatorTest {
     ...
     * process *is* `com.dresos.lattice` — stopping it would kill the test mid-teardown and surface as
