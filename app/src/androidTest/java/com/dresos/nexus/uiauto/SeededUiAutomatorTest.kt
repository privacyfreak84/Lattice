...
/**
 * Base for the **UIAutomator** black-box suite (`com.dresos.nexus.uiauto`). Where the Compose suite
 * ([com.dresos.nexus.ui.SeededUiTest]) drives the app *in-process* via the semantics tree, this drives the
...
abstract class SeededUiAutomatorTest {
     ...
     * process *is* `com.dresos.nexus` — stopping it would kill the test mid-teardown and surface as
