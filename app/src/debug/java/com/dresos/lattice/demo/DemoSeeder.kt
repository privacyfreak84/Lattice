 ...
 * so both stay in lockstep. Paired with [com.dresos.lattice.mesh.DemoTransport], which reports
...
class DemoSeeder(
    ...
    companion object {
        ...
        /** The subset of demo peers reported as connected by [com.dresos.lattice.mesh.DemoTransport]. */
