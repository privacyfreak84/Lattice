 ...
 * so both stay in lockstep. Paired with [org.lattice.mesh.DemoTransport], which reports
...
class DemoSeeder(
    ...
    companion object {
        ...
        /** The subset of demo peers reported as connected by [org.lattice.mesh.DemoTransport]. */
