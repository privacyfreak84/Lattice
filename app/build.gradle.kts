...
android {
    ...
    defaultConfig {
        applicationId = "com.dresos.nexus"
    ...
    testOptions {
        ...
        unitTests {
            ...
            // executes the real eviction/GC SQL. See app/src/test/java/com/dresos/nexus/data/ and
        ...
        managedDevices {
            localDevices {
                ...
                // Headless emulator for the accessibility suite (com.dresos.nexus.a11y): the Compose ATF
                ...
                // -PseedDemo=true -Pandroid.testInstrumentationRunnerArguments.package=com.dresos.nexus.a11y`.
    ...
    sourceSets {
        ...
        // See NexusDatabaseMigrationTest.
        getByName("debug") {
...
room {
    ...
    // the flat schemas/com.dresos.nexus.data.NexusDatabase/<version>.json — same layout the ksp arg produced —
    // which the debug sourceSet below serves as a unit-test asset so MigrationTestHelper can read it.
    // Requires exportSchema = true on NexusDatabase; regenerate the checked-in schema by clearing app/schemas/
...
dependencies {
    ...
    // by Room). See app/src/test/java/com/dresos/nexus/data/.
    ...
    // a11y package (com.dresos.nexus.a11y, @RequiresApi(34)). See .agents/context/testing.md.
    ...
    // UIAutomator black-box suite (com.dresos.nexus.uiauto): drives the real app process via resource-ids
